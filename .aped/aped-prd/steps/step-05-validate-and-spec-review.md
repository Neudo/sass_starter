...
1. **Placeholder lint** — `bash .aped/scripts/lint-placeholders.sh docs/aped/prd.md`. Exit 0 = pass. Fix flagged TBD / TODO / lone ellipses inline.
...
```bash
bash .aped/aped-prd/scripts/validate-prd.sh docs/aped/prd.md
bash .aped/aped-prd/scripts/oracle-prd.sh docs/aped/prd.md
```
...
```bash
bash .aped/scripts/validate-prd.sh docs/aped/prd.md
```
