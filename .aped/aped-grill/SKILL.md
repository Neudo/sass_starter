...
3. Any prior PRD at `docs/aped/prd.md` — load if present, never invent its content.
4. Any prior architecture at `docs/aped/architecture.md` — load if present.
...
Write to `docs/aped/grill-summary.md`. Always overwrite — last grill wins; prior grilling lives in git.
