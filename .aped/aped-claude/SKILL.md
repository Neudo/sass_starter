...
- **Validate before persisting** to `docs/aped/`.
...
- Engine: `.aped/` (immutable) · Artifacts: `docs/aped/` (evolves)
- State: `docs/aped/state.yaml` · Lessons: `docs/aped/lessons.md`
- Project: {{project_name}} ({{user_name}}, {{communication_language}})

## Lessons File

Also ensure `docs/aped/lessons.md` exists. If missing, create it with the template:
...
2. Ensure `docs/aped/lessons.md` exists
