...
3. **Sprint state.** Read `docs/aped/state.yaml` to know whether a sprint is active (informs whether `aped-arch-audit` or `aped-retro` is the right step 08 handoff candidate).
