...
1. Read `docs/aped/state.yaml` → extract `pipeline.current_phase`.
2. Read `docs/aped/epics.md` → identify the active epic's file set.
...
Write `docs/aped/triage-decision.md`:
