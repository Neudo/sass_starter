...
1. **Placeholder lint** — `bash .aped/scripts/lint-placeholders.sh docs/aped/product-brief.md`. Exit 0 = pass.
...
```bash
bash .aped/aped-analyze/scripts/validate-brief.sh docs/aped/product-brief.md
```
...
Create / update `docs/aped/state.yaml`:
...
pipeline:
  ...
  phases:
    analyze:
      status: "done"
      output: "docs/aped/product-brief.md"
```
