...
2. Read in this order:
   - `docs/aped/prd.md` — FRs covered by this epic.
   - `docs/aped/architecture.md` — system-level decisions already locked.
   - `docs/aped/epics.md` — the epic's stated scope, the stories it lists, the FR coverage map.
   - `docs/aped/epics-context/epic-{N}-context.md` — REQUIRED. If missing, HALT and tell the user to invoke `aped-story` once first (it produces this cache) before running `aped-discuss-epic`.
...
Open `docs/aped/epics-context/epic-{N}-context.md`.
...
Run `bash .aped/scripts/validate-epic-context.sh docs/aped/epics-context/epic-{N}-context.md`. WARN-only — surface but do not block.
