...
1. Read `docs/aped/prd.md` — what are we building?
2. Read `docs/aped/architecture.md` — how are we building it?
3. Read `docs/aped/epics.md` — what's the scope?
