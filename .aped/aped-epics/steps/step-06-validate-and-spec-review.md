...
```bash
bash .aped/aped-epics/scripts/validate-coverage.sh docs/aped/epics.md docs/aped/prd.md
bash .aped/aped-epics/scripts/oracle-epics.sh docs/aped/epics.md docs/aped/prd.md
```
