...
Elicit does NOT update `docs/aped/state.yaml`. It's a horizontal tool.
...
User: "aped-elicit docs/aped/architecture.md"

1. Setup: confirm target = `docs/aped/architecture.md`, section = "Database choice (Postgres vs Foundation)"
...
10. User: "y" then "x"
11. Summary: "Applied Pre-mortem + Tree of Thoughts to docs/aped/architecture.md. 2 subsections enhanced."
...
User: x → enhanced content returns to `aped-prd`, which presents to user for final validation before writing to `docs/aped/prd.md`.
