  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (data.email === "demo@dana.ai" && data.password === "dana2025") {
        ...
        // Use onLogin function to change state and navigate
        onLogin();
      } else {
          ...
          <Card className="border-0 shadow-xl bg-card">
            <CardHeader className="space-y-1 pb-4">
              ...
              <CardDescription className="text-center">
                Access your AI insights and advanced analytics
              </CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <Badge
                variant="outline"
                className="w-full justify-center py-2 border-primary/20 text-primary bg-primary/5"
              >
                Demo: demo@dana.ai / dana2025
              </Badge>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <Button
                    type="button"
                    variant="link"
                    className="px-0 text-secondary hover:text-ring"
            ...
            <CardFooter className="flex flex-col space-y-2">
              ...
              <div className="text-xs text-center text-muted-foreground">
                ...
                <a
                  href="#"
                  className="text-secondary hover:text-ring hover:underline"
                >
                  terms of service
                </a>{" "}
                and{" "}
