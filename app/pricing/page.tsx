...
export const metadata = {
  ...
  description: "Choose the perfect privacy-first analytics plan for your website. Cookie-free tracking from $9/month. GDPR compliant Google Analytics alternative with real-time insights.",
  keywords: ["privacy analytics pricing", "cookie-free analytics cost", "Google Analytics alternative pricing", "GDPR compliant analytics plans"],
};
            ...
            <div className="text-center mb-16">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Discover in detail what&apos;s included in each plan to make
                  the best choice.
                </p>
              </motion.div>
            </div>
